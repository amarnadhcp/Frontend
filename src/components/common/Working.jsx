...
const Working = () => {
  return (
    <>
    <div className="flex h-auto justify-center items-center bg-violet-900">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-5xl p-4 md:p-8">
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden transition-transform transform hover:scale-105 relative">
          ...
          ></div>
          <div className="p-4">
            <h2 className="text-xl font-semibold mb-2">Find The Freelancer</h2>
...
<div className="bg-new-color h-auto md:h-96 flex flex-col justify-center items-center p-4 md:p-8">
