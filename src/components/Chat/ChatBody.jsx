...
import { addMessage, getAllMessages } from "../../api/userApi";
...
function ChatBody({ sender, socket }) {
  ...
  useEffect(() => {
    if (sender.id) {
      getAllMessages(sender.id, userData.id).then(({ data: { messages } }) => {
                    ...
                    {message.fromSelf ? (
                      <div className="col-start-6 col-end-13 p-3 rounded-lg">
                        <div className="flex items-center justify-start flex-row-reverse">
                          <div className="flex items-center justify-center h-10 w-10 rounded-full bg-indigo-500 flex-shrink-0">
                            <img
                              src={userData.image || "https://res.cloudinary.com/dvprhxg7x/image/upload/v1692803989/asset/noavatar_vhrf74.jpg"}
                              alt="Avatar"
                      ...
                      <div className="col-start-1 col-end-8 p-3 rounded-lg">
                        <div className="flex flex-row items-center">
                          <div className="flex items-center justify-center h-10 w-10 rounded-full bg-indigo-500 flex-shrink-0">
                            <img
                              src={sender?.img || "https://res.cloudinary.com/dvprhxg7x/image/upload/v1692803989/asset/noavatar_vhrf74.jpg"}
                              alt="Avatar"
                              className="h-full w-full rounded-full"
                            />
                          </div>
